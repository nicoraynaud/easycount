...
public class BankAccountResource {
    ...
    @Timed
    public ResponseEntity<List<BankAccountDTO>> searchBankAccounts(@RequestParam String query, @ApiParam Pageable pageable) {
        log.debug("REST request to search for a page of BankAccounts for query {}", query);
        Page<BankAccountDTO> page = bankAccountService.search(query, pageable);
